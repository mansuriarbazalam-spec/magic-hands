...
export default class HoloTorus {
  constructor(position = { x: 0, y: 0, z: 0 }) {
    ...
    const geometry = new THREE.TorusGeometry(0.5, 0.15, 12, 36);
    ...
    // Particles
    this.particles = createParticles(0.75);
    this.group.add(this.particles);

    // Structural enhancements (on group — stay level)
    this._enhancements.orbitRing = addOrbitRing(this.group, 0.75);
    this._enhancements.orbitRing2 = addOrbitRing2(this.group, 0.75);
    addCrossSections(this.group, 0.75);
    addMeasurementLines(this.group, 0.75);
    addGroundRing(this.group, 0.75);
    addAxisLines(this.group, 0.75);
